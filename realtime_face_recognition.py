...
known_face_encodings = [modi_face_encodings, trump_face_encodings, sreya_face_encodings, veeru_face_encodings]
known_face_names = ["Narendra Modi", "Donald Trump", "Sreya" ,"Veera"]
